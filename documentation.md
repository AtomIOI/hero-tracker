...
The "Powers" page allows users to manage their character's powers. The page displays a list of powers, and users can add, edit, or delete powers. The availability of each power is determined by the GYRO (Green, Yellow, Red, Out) system, which is based on the character's current health.

### GYRO System

- **Green:** Only Green powers are available.
- **Yellow:** Green and Yellow powers are available.
- **Red:** Green, Yellow, and Red powers are available.
- **Out:** No powers are available.
